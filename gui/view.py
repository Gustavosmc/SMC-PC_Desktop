...
HAB_AUTOCOMPLETE = "Habilitar Autocomplete"
DIS_AUTOCOMPLETE = "Desabilitar Autocomplete"
...
class MainWindow(object):
    def __init__(self, tk_instance):
        ...
        self.tk_instance.set_window(self)
        ...
        self.bt_init_server['background'] = BT_COLOR
        ...
        self.bt_close_server['background'] = BT_COLOR
    ...
    def init_server(self, event):
        ...
        if len(interface) > 0:
            ...
            messagebox.showinfo("Aviso", "Selecione uma rede")
            return
        if self.server is not None:
        ...
        if ip is None:
            messagebox.showinfo("Aviso", "impossivel criar conexão nesta interface de rede")
            return
        time = 20
